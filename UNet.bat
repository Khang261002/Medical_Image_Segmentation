...
for /l %%i in (0, 1, 10) do (
    ...
    python main.py --model_type=!a! --dataset="CHASE_DB1" --data_path="./data/" --augmentation_prob=0.6
    python main.py --model_type=!a! --dataset="STARE" --data_path="./data/" --augmentation_prob=0.6
